...
#
# This file is taken from GPflow https://github.com/GPflow/GPflow
# Thanks!
#
...
class TransformTests(unittest.TestCase):
    def setUp(self):
        ...
        self.transforms = [C() for C in hb.transforms.Transform.__subclasses__()]
        self.transforms.append(hb.transforms.Logistic(7.3, 19.4))
    ...
    def test_logjac(self):
        ...
        tf_jacs = [tf.log(tf.matrix_determinant(jacobian(t.tf_forward))) for t in self.transforms if
                   type(t) is not hb.transforms.LowerTriangular]
...
class TestLowerTriTransform(unittest.TestCase):
    ...
    def setUp(self):
        self.t = hb.transforms.LowerTriangular(3)
